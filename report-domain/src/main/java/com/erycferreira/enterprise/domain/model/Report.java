...
public class Report {
  ...
  public void startProcessing() {
    if (this.status != ReportStatus.CREATED) {
      throw new ReportAlreadyProcessingException("Report cannot start processing from status: " + this.status);
    }
  ...
  public void complete() {
    if (this.status != ReportStatus.PROCESSING) {
      throw new ReportAlreadyProcessingException("Report can only be completed if processing");
    }
  ...
  public void fail() {
    if (this.status != ReportStatus.PROCESSING) {
      throw new ReportAlreadyProcessingException("Report can only fail if processing");
    }
